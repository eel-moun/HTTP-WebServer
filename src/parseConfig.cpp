...
{
    array<string, 16> keys = {"host", "default_error", "max_size", "server_name", "listen", "server", "location", "path", "index", "root", "allowed_method", "autoindex", "upload_dir", "return", "cgi_ext", "cgi_path"};
    int i = 0;
